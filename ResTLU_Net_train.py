...
if __name__ == '__main__':
    ...
    optional.add_argument('-epoch', '--num_epoch', type=int, default=10, help='Number of Epoch')
    ...
    model = ResTLU_Net_model.Re_UNet2d(dim_in=3, num_conv_block=5, kernel_root=16)
    ...
    for epoch in range(0, args.num_epoch):
        ...
        for i, (cimg, bmsk) in enumerate(volume_loader):
            block_dataset = BlockDataset(rimg=cimg, bfld=None, bmsk=bmsk, num_slice=args.input_slice,
    ...
    # feihong
    # DL_Dict["dice_mean"] = dice_array_mean
